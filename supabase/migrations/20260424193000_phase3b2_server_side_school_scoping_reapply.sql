-- Re-apply the verified server-side school-scoping pass after
-- 20260424160000_phase3b2_server_side_school_scoping_rollback.sql.
-- Keep this migration limited to the RPC/helper definitions that were
-- originally introduced by 20260424133000_phase3b2_server_side_school_scoping.sql.
