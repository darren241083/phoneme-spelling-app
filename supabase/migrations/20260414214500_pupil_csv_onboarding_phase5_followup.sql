-- Follow-up migration for pupil CSV onboarding.
-- Idempotently restates the pupil onboarding objects so production can catch up
-- even if an earlier draft migration was never applied.
