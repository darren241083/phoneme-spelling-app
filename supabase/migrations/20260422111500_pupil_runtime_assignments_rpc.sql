...
ALTER FUNCTION "public"."read_pupil_runtime_assignments"("requested_pupil_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."read_pupil_runtime_assignments"("requested_pupil_id" "uuid") FROM PUBLIC;
GRANT EXECUTE ON FUNCTION "public"."read_pupil_runtime_assignments"("requested_pupil_id" "uuid") TO "anon";
GRANT EXECUTE ON FUNCTION "public"."read_pupil_runtime_assignments"("requested_pupil_id" "uuid") TO "authenticated";
GRANT EXECUTE ON FUNCTION "public"."read_pupil_runtime_assignments"("requested_pupil_id" "uuid") TO "service_role";
