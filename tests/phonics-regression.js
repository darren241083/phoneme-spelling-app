...
const CASES = [
  ...
  { word: "theme", expectedSegments: ["th", "e-e", "m"], split: true, focus: "e-e", underlineRanges: [[0, 1]] },
  ...
  { word: "fleece", expectedSegments: ["f", "l", "ee", "c", "e"], split: false, focus: "ee", underlineRanges: [[2, 3]] },
  { word: "cheese", expectedSegments: ["ch", "ee", "s", "e"], split: false, focus: ["ch", "ee"], underlineRanges: [[0, 1], [2, 3]] },
  { word: "breeze", expectedSegments: ["b", "r", "ee", "z", "e"], split: false, focus: "ee", underlineRanges: [[2, 3]] },
  { word: "boated", expectedSegments: ["b", "oa", "t", "e", "d"], split: false, focus: "oa", underlineRanges: [[1, 2]] },
  { word: "nailed", expectedSegments: ["n", "ai", "l", "e", "d"], split: false, focus: "ai", underlineRanges: [[1, 2]] },
